...
Program SVO (Semi-direct Monocular Visual Odometry) [odwolanie do artykulu] jest zaimplementowany w ROSie. Wykorzystuje on obrazy dostarczone z pok³adowej kamery. Quadrocopter zbiera informacje ze ¶rodowiska poprzez zdjêcia w dyskretnych chwilach czasu
\begin{equation*}
I_1,I_2, \ldots, I_n.
\end{equation*}
